...
**Cache Control:**
- `ignorecache=1` - Force a refetch and re-render of this variant. Requires header `X-Invalidate-Key` matching `invalidate_token`; without it the parameter is ignored and the request is served from cache.
